...
@section('content')
    ...
    <div class="auto-container my-4" style="padding: 100px 0px 150px;">
        ...
        <ul>
            ...
            <li>
                <p><strong>Website</strong> refers to Stake Farm, accessible from <a href="https://stakefarmltd.com/"
                        rel="external nofollow noopener" target="_blank">https://stakefarmltd.com/</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: support@stakefarmltd.com</p>
            </li>
            <li>
                <p>By phone number: +12093400260</p>
            </li>
            <li>
